...
export default function Edit({ attributes, setAttributes, clientId }) {
	...
	const cover = attributes?.coverImage?.url ? attributes?.coverImage?.url : "https://placehold.co/600x400?text=Cover+Video";
		...
		<>
			...
			<div {...blockProps}>
				<div className="video-root">
					<div id="video-markup"></div>
					<div className="cover-video-content-overlay active" style={{ backgroundImage: `url(${cover})` }}>
